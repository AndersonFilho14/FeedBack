...
from infra.db.settings.base import (
    Base,
)  # Assumindo que este é o caminho correto para sua Base Declarativa
...
class Acesso(Base):
    ...
    def __repr__(self) -> str:
        return (
            f"<Acesso id={self.id}, usuario='{self.usuario}', cargo_id={self.id_cargo}>"
        )
