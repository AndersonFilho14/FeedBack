...
export default function ListaAlunos() {
  // Agora alunos é um array com nomes
  ...
  // Índice do aluno para confirmação de exclusão
  const [confirmIdx, setConfirmIdx] = useState<number | null>(null);

  // Função para excluir aluno confirmado
            ...
            {alunos.map((aluno, idx) => (
              ...
              >
                ...
                <div className="flex gap-4">
                  ...
                  >
                    <img className="w-11" src="/imagem/lixo.png" alt="Excluir aluno" />
                  </button>
                </div>
              </div>
            ))}
